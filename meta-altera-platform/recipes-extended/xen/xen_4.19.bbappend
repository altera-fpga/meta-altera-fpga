...
SRC_URI = " \
	...
	file://0001-arm-fix-TEECR32-TEEHBR32-register-encoding-for-newer.patch \
	"

# xen-syms embeds the build TMPDIR in its debug info by design; skip the check.
INSANE_SKIP:xen-dbg += "buildpaths"
